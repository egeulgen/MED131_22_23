...
sched_df$Subject[14] <- paste(kableExtra::cell_spec("Power Analysis", "html", link = paste0(base_url, "lectures/13.power_analysis.pdf")),
                              kableExtra::cell_spec("Review", "html", link = paste0(base_url, "lectures/13.review.pdf")), sep = " / ")
